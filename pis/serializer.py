...
class PatientSerializer(serializers.ModelSerializer):
    model = Patient
    fields = ('name', 'date_of_birth', 'phone_number', 'gender', 'id_number', 'status', 'email', 'registration_number', 'blood_group', 'next_of_kin', 'medications', 'medical_cover', 'allergies_and_directives', 'doctor', 'profile_photo')
